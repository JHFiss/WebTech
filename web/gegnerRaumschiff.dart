...
class GegnerRaumschiff extends Raumschiff{
  ...
  GegnerRaumschiff(String _farbe, Koordinaten _position, int _gH,
      int _gV, int _id, List<Koordinaten> _form, int _leben, int _laserIDref,
      this._bewegungsmuster, this._angriffsmuster)
      : super(_farbe, _position, _gH,
          _gV, _id, _form, _leben, _laserIDref);
  ...
  bool get getNextSchuss => _angriffsmuster[++_amIterator] ? true : false;
}